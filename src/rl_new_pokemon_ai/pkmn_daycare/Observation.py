...
Agent = npt.NDArray[int]
Pkmn = npt.NDArray[int]


@dataclass
class Observation:
    """
    This class is a wrapper around the observation type Dict[str, Pkmn]*
    It mainly serves as an index helper.

    The functions here are placeholders to
    """
    ...
    def pkmn_ko(self, agent: int, pkmn: int) -> Dict[str, int]:
        """
