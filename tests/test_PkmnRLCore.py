    ...
    def test_create_team(self):
        ...
        for i in range(6):
            ...
            self.assertEqual(
                ...
                player_team[start],
                "Player team ID mismatch at pokemon {i}",
            )
            self.assertEqual(
                read_player_team[start + 1],
                player_team[start + 1],
                "Player team level mismatch at pokemon {i}",
            )
            self.assertEqual(
                read_player_team[start + 2 : start + 6],
                player_team[start + 2 : start + 6],
                "Player team moves mismatch at pokemon {i}",
            )
            self.assertEqual(
